...
<<<<<<< HEAD
	reader, err := rpchelper.CreateHistoryStateReader(tx, 1, 0, false, 0, genSpec.Config.ChainName)
=======
	reader, err := rpchelper.CreateHistoryStateReader(tx, 1, 0, historyV3, 0, genSpec.Config.ChainName)
>>>>>>> v1.2.5
	require.NoError(err)
